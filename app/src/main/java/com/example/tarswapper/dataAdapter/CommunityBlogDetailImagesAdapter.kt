...
//adapter can refer to product detail images adapter
class CommunityBlogDetailImagesAdapter(private val imageUrls: List<String>) : RecyclerView.Adapter<CommunityBlogDetailImagesAdapter.ImageViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ImageViewHolder {
        //make sure using slider images slide
