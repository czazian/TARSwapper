...
class CommunityCommentAdapter(private val commentList: List<CommunityComment>, private val context: Context) : RecyclerView.Adapter<CommunityCommentAdapter.CommentViewHolder>() {
