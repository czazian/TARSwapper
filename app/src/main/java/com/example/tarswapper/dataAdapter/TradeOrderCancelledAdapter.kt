...
class TradeOrderCancelledAdapter(private var orderList: List<Order>, private val context : Context) :
    RecyclerView.Adapter<TradeOrderCancelledAdapter.OrderViewHolder>() {
